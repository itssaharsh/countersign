...
3. If ready_to_commit is true, call commit_change with the simulation_id and undo_token
   IN THE SAME TURN, right after a two-line summary of the three proofs. Do not end your
   turn to ask whether to proceed — the commit call itself is the question: it pauses for
   human approval, and that pause is the product working, not an error.
